...
This plugin allows users without Internet access to still use your app. It requires that your application can
...
In order to make offline use of your app possible, the plugin will generate an installer bundle, which is an
...
make changes to an offline group's records, not even the administrator; this is enforced by the plugin at a
low level.
