class CreateOfflineBridgeTables < ActiveRecord::Migration
	def self.up
		create_table :offline_bridge_group_states, :force => true do |t|
		...
		create_table :offline_bridge_model_states, :force => true do |t|
			t.column :app_model_name, :string
		end
		
		create_table :offline_bridge_group_model_pairings, :force => true do |t|
		...
		create_table :offline_bridge_transformed_ids, :force => true do |t|
	...
	def self.down
		drop_table :offline_bridge_group_states
		drop_table :offline_bridge_model_states
		drop_table :offline_bridge_group_model_pairings
		drop_table :offline_bridge_transformed_ids
	end
end
